...
..
.
include::{sourceDir}/../complete/build.gradle[tag=substratevm]
}
----
...
Step 1/10 : FROM oracle/graalvm-ce:19.2.1 as graalvm
 ---> d8c8cb0dedca
...
Removing intermediate container 345a08932afb
 ---> 20d0a0d73273
Step 5/10 : RUN native-image --no-server -cp build/libs/complete-0.1-all.jar
...
Step 7/10 : EXPOSE 8080
 ---> Using cache
 ---> 7d24ddc7d4b9
Step 8/10 : COPY --from=graalvm /opt/graalvm-ce-19.2.1/jre/lib/amd64/libsunec.so /app/libsunec.so
 ---> 78b21f6420c0
Step 9/10 : COPY --from=graalvm /home/app/micronautguide/micronautguide /app/micronautguide
 ---> 2cd5a7232645
Step 10/10 : ENTRYPOINT ["/app/micronautguide", "-Djava.library.path=/app"]
 ---> Running in b7280b0816d2
Removing intermediate container 2cd5a7232645
 ---> 27620cb4e0a3
